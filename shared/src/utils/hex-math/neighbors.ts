 ...
 */
const FLAT_TOP_DIRECTIONS: AxialCoordinate[] = [
  { q: 1, r: 0 },   // E
  { q: 1, r: -1 },  // NE
  { q: 0, r: -1 },  // NW
  { q: -1, r: 0 },  // W
...
const POINTY_TOP_DIRECTIONS: AxialCoordinate[] = [
  { q: 1, r: -1 },  // NE
  { q: 1, r: 0 },   // E
  { q: 0, r: 1 },   // SE
  { q: -1, r: 1 },  // SW
 ...
 */
export function hexNeighbors(hex: AxialCoordinate, config: HexGridConfig): AxialCoordinate[] {
 ...
 */
export function isValidHex(hex: AxialCoordinate, config: HexGridConfig): boolean {
