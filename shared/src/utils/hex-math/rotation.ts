...
import { AxialCoordinate, CubeCoordinate } from './types';
 ...
 */
export function hexRotate(hex: AxialCoordinate, center: AxialCoordinate, steps: number): AxialCoordinate {
 ...
 */
function rotateCubeClockwise(cube: CubeCoordinate): CubeCoordinate {
  return {
    x: -cube.z,
    y: -cube.x,
    z: -cube.y
 ...
 * @returns Rotated hex coordinate
 */
export function hexRotateRight(hex: AxialCoordinate, center: AxialCoordinate): AxialCoordinate {
 ...
 * @returns Rotated hex coordinate
 */
export function hexRotateLeft(hex: AxialCoordinate, center: AxialCoordinate): AxialCoordinate {
  return hexRotate(hex, center, -1);
}
